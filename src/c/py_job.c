...
static int JobObjectPy_init(JobObjectPy *self, PyObject *args, PyObject *kwds) {
  ...
  PyErr_SetString(PyExc_NotImplementedError,
                  "Direct Job() construction is not supported. Use a factory "
                  "class instead.");
  return -1;
}
...
static PyObject *JobObjectPy_run(JobObjectPy *self, PyObject *args,
                                 PyObject *kwargs) {
  ...
  if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O!O!", kwlist, &OdeTypePy,
                                   &ode_obj, &SolverTypePy, &solver_obj)) {
    return NULL;
  }
  ...
  result_t result =
      solver_obj->solver->set_data(solver_obj->solver, ode_obj->ode);
  ...
  result =
      self->factory->output->fn(ode_obj->ode, solver_obj->solver, self->args);
  if (result.type == FAILURE) {
    PyErr_SetString(PyExc_RuntimeError, result.message);
    return NULL;
  }
...
static PyObject *JobObjectPy_get_arguments(JobObjectPy *self,
...
static PyObject *JobObjectPy_get_factory(JobObjectPy *self,
                                         PyObject *Py_UNUSED(ignored)) {
  if (!self->factory) {
...
static PyObject *JobFactoryObjectPy_new(PyTypeObject *type, PyObject *args,
                                        PyObject *kwds) {
  (void)args;
  (void)kwds;
...
static int JobFactoryObjectPy_init(JobFactoryObjectPy *self, PyObject *args,
                                   PyObject *kwds) {
...
static PyObject *JobFactoryObjectPy_get_name(JobFactoryObjectPy *self,
                                             PyObject *Py_UNUSED(ignored)) {
...
// their types
static PyObject *
JobFactoryObjectPy_get_argument_types(JobFactoryObjectPy *self,
                                      PyObject *Py_UNUSED(ignored)) {
  return py_get_list_from_args(self->output->args, 0);
}

static PyObject *JobFactoryObjectPy_create(JobFactoryObjectPy *self,
...
static PyMethodDef JobObjectPy_methods[] = {
    {"run", (PyCFunction)(void (*)(void))JobObjectPy_run,
     METH_VARARGS | METH_KEYWORDS,
     "Run the job with given ODE, solver, and arguments."},
    {"get_arguments", (PyCFunction)(void (*)(void))JobObjectPy_get_arguments,
     METH_NOARGS, "Return the arguments of the job."},
    {"get_factory", (PyCFunction)(void (*)(void))JobObjectPy_get_factory,
     METH_NOARGS, "Return the factory object."},
    {NULL, NULL, 0, NULL} /* Sentinel */
};

static PyMethodDef JobFactoryObjectPy_methods[] = {
    {"create", (PyCFunction)(void (*)(void))JobFactoryObjectPy_create,
     METH_VARARGS | METH_KEYWORDS, "Create a Job object."},
    {"get_name", (PyCFunction)JobFactoryObjectPy_get_name, METH_NOARGS,
     "Return the name of the Job."},
    {"get_argument_types", (PyCFunction)JobFactoryObjectPy_get_argument_types,
...
PyTypeObject JobTypePy = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "dynamical_systems.Job",
...
PyTypeObject JobFactoryTypePy = {
    PyVarObject_HEAD_INIT(NULL, 0).tp_name = "dynamical_systems.JobFactory",
