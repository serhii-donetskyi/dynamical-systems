...
// Copies the arguments and returns a new list of dictionaries, or NULL on
// error args: a list of dictionaries of the arguments kwargs: a dictionary of
// the arguments args_in: a list of the arguments returns: a new list of
// dictionaries, or NULL on error and sets an error message
