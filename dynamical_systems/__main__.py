...
def add_run_parser(subparsers):
    ...
    parser.add_argument(
        "--solver", type=str, required=True, help="Solver to use (default: rk4)"
    )
    ...
    parser.add_argument(
        "--job", type=str, required=True, help="Job to use (default: portrait)"
    )
